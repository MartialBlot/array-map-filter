...
function getMoviesFreshness(movies) {
  return result = movies.map(movies => (movies.rating<60) ? movies.label =`label :'rotten'` :(movies.rating>75) ? Object.defineProperty(movies, "label",{value :'certified fresh'}) : Object.defineProperty(movies, "label", {value :'fresh'}))
}
