...
function getCirclesProperties(radiuses) {
  //arr = [];
  let un = radiuses*Math.PI*2;
  return radiuses.map ( radiuses => [radiuses["radius"] = radiuses , radiuses1["circumference"] = un.toFixed(3) , radiuses["surface"] = radiuses*radiuses*Math.PI])
}
