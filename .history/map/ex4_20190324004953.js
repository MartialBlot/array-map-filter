...
function getCirclesProperties(radiuses) {
  return radiuses.map ( radiuses => [Object.create(radiuses) =  radiuses , radiuses["circumference"] = (radiuses*Math.PI*2).toFixed(3) , radiuses["surface"] = (radiuses*radiuses*Math.PI).toFixed(3)])
}
