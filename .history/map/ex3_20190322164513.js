...
function getMoviesFreshness(movies) {
  movies = movies.map(movies => (movies.rating<60) ? Object.defineProperty(movies, "label", {value :'rotten'}):(movies.rating>75) ? Object.defineProperty(movies, "label",{value :'certified fresh'}) : Object.defineProperty(movies, "label", {value :'fresh'}))
  return Object.getOwnPropertyNames(movies)
}
